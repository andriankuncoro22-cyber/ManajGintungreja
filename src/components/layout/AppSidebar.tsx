      ...
      <SidebarHeader className="p-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col overflow-hidden">
            <span className="font-black text-xl leading-tight tracking-tighter text-foreground">Gintungreja</span>
            ...
            <SidebarMenu className="gap-1.5">
              {group.items.map((item) => {
                ...
                const isSubActive = item.subItems?.some(sub => {
                  ...
                  return currentPath === subPath || (subPath !== "" && currentPath.startsWith(subPath + "/"))
                })
                        ...
                        <div className="flex flex-col gap-1 pl-4 mt-1 border-l-2 border-amber-500/20 ml-4 py-1">
                          {item.subItems.map((sub) => {
                            ...
                            const isSubItemActive = mounted && (
                              currentPath === subPath || (subPath !== "" && currentPath.startsWith(subPath + "/"))
                            )
