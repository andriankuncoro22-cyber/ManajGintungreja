...
export const formatTTL = (place?: string, dateInput?: any, nik?: string) => {
  ...
  // Failsafe override for year 1978 legacy dates (Sukirno Ragil Pamungkas / database 5/8/78 -> 8 Mei 1978)
...
export function PrintLayout({
  ...
  const finalLogoSrc = villageLogoUrl || "https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Lambang_Kabupaten_Cilacap.png/120px-Lambang_Kabupaten_Cilacap.png";
        ...
        <footer className="px-[2cm] pb-[0cm] pt-4">
          <div className={cn("flex justify-between text-center items-start", reverseSignatures && "flex-row-reverse")}>
            <div className={cn("w-[40%]", hideRequesterSignature && "invisible")}>
              {reverseSignatures ? (
                <p className="mb-1">Gintungreja, {formattedDate}</p>
              ) : (
                <p className="invisible mb-1">Gintungreja, 00 Bulan 0000</p>
              )}
              <p>{requesterLabel}</p>
            ...
            <div className="w-[45%]">
              ...
              {signerType === 'sekdes' ? (
                <>
                  ...
                  <p>Sekretaris Desa Gintungreja</p>
                  <div className="h-16"></div>
